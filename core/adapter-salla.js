...
{% hook 'component:product.grid.end' %}`;
  ...
  writeOpt('date', `<input class="form-input date-element{{ option.required?' required':'' }}" placeholder="{{ option.placeholder }}" name="options[{{ option.id }}]" {{ option.attributes|raw }} readonly="readonly" value="{{ option.value }}" type="text" />`);
  writeOpt('datetime', `<input class="form-input date-time-element{{ option.required?' required':'' }}" placeholder="{{ option.placeholder }}" name="options[{{ option.id }}]" {{ option.attributes|raw }} readonly="readonly" value="{{ option.value }}" type="text" />`);
  ...
  writeOpt('single-option', `<select name="options[{{ option.id }}]" data-option="{{ option.id }}" {{ option.attributes|raw }}><option placeholder value="">{{ option.placeholder }}</option>{% for key,detail in option.details %}<option {{ detail.is_selected ? 'selected' : '' }} value="{{ detail.id }}">{{ detail.full_name | default(detail.name) }}</option>{% endfor %}</select>`);
  writeOpt('splitter', `<div class="splitter"></div>`);
  writeOpt('text', `<input placeholder="{{ option.placeholder }}" name="options[{{ option.id }}]" {{ option.attributes|raw }} value="{{ option.value }}" type="text"/>`);
  writeOpt('textarea', `<textarea placeholder="{{ option.placeholder }}" name="options[{{ option.id }}]" {{ option.attributes|raw }}>{{ option.value }}</textarea>`);
  ...
  writeOpt('time', `<input placeholder="{{ option.placeholder }}" name="options[{{ option.id }}]" {{ option.attributes|raw }} readonly="readonly" value="{{ option.value }}" type="text"/>`);
