...
class SchemaValidator {
  ...
  _compile(){ const schema = { $schema:"http://json-schema.org/draft-07/schema#", type:"object", required:["layout","components","assets"], properties:{ layout:{type:"object"}, components:{ type:"array"}, assets:{ type:"object"}, metadata:{ type:"object"}, smartFeatures:{ type:"object"} }, additionalProperties:true }; this.validateFn = this.ajv.compile(schema); }
